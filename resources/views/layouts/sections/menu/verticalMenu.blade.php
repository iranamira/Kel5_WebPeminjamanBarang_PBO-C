<aside id="layout-menu" class="layout-menu menu-vertical menu bg-sky-950 w-[20rem]">
  ...
  <div class="app-brand demo justify-center">
    <a href="{{ route('dashboard') }}" class="app-brand-link mt-4">
      <span class="app-brand-text demo menu-text fw-semibold ms-2" style="color: #f5f5f5;">Peminjaman Barang</span>
    </a>
  </div>
  ...
  <ul class="menu-inner py-1">
    <li class="menu-item mt-5 ms-4">
      <a href="{{ route('dashboard') }}" class="menu-link">
        ...
        <span style="color: #f5f5f5;">Daftar Barang</span>
      </a>
    </li>
    <li class="menu-item  ms-4">
      <a href="{{ route('form') }}" class="menu-link">
        <i class=" fa-regular fa-file-lines fa-sm text-2xl mr-10" style="color: #f5f5f5;"></i>
        <span style="color: #f5f5f5;">Form Peminjaman</span>
      </a>
    </li>
    <li class="menu-item ms-4">
      <a href="{{ route('list') }}" class="menu-link">
        <i class=" fa-regular fa-copy fa-sm text-2xl mr-10" style="color: #f5f5f5;"></i>
        <span style="color: #f5f5f5;">Form Tersubmit</span>
      </a>
    </li>
  </ul>
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = '/login';  // Ganti sesuai dengan URL login Anda
                                });
                            },
                            error: function () {
                                Swal.fire({
